      ...
      ))}
      {
        isVisible && (
          <div className="plasmo-overlay">
            ...
            <div className={`plasmo-overlay-item ${isCurrentStatus === buttonStatus.text ? 'active' : ''}`} onClick={() => createTextBox()}>
            ...
            <div className="plasmo-overlay-item" onClick={() => { setIsSetting(prev => !prev); setIsCurrentStatus(buttonStatus.other) } }>
            ...
            <div className="plasmo-overlay-item action-arrow">
